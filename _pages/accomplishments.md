...
<div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 30px; margin: 40px 0;">
  <div style="text-align: center;">
    <img src="{{ site.baseurl }}/images/cert1.jpg" alt="Certificate 1" style="width: 100%; height: 300px; object-fit: cover; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.15);">
    <p style="font-style: italic; color: #666; margin-top: 10px;">Deep Learning Specialization - Coursera</p>
  </div>
  
  <div style="text-align: center;">
    <img src="{{ site.baseurl }}/images/cert2.jpg" alt="Certificate 2" style="width: 100%; height: 300px; object-fit: cover; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.15);">
    <p style="font-style: italic; color: #666; margin-top: 10px;">Machine Learning - Stanford University</p>
  </div>
</div>
